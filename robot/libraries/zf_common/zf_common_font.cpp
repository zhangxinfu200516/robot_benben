...
const ChineseFont custom_font[] = {
    ...
    {{0xD0, 0xD0}, {
        ...
        0x10,0x00,0x10,0x00,0x11,0xF8,0x11,0x08,
        0xFD,0x08,0x11,0x08,0x11,0x08,0x11,0x08,
        0x11,0x10,0x11,0x10,0x10,0xE0,0x00,0x00
    }},
    // 道
    {{0xB5, 0xC0}, {
        0x00,0x00,0x00,0x00,0x1F,0xF0,0x10,0x10,
        0x10,0x10,0x1F,0xF0,0x00,0x00,0x00,0x00,
        0x3F,0xF8,0x00,0x08,0x00,0x08,0x00,0x08,
        0x00,0x08,0x00,0x08,0x3F,0xF8,0x00,0x00
    }},
    // 前
    {{0xC7, 0xB0}, {
        0x00,0x00,0x00,0x00,0x3F,0xF8,0x00,0x08,
...
const ChineseFont chinese_font_16x16[] = {
    // 人
    {{0xC8, 0xCB}, {    
        0x01, 0x00, 
        0x01, 0x00, 
...
// 定义字库大小
const uint16_t CHINESE_FONT_COUNT = sizeof(chinese_font_16x16) / sizeof(ChineseFont);